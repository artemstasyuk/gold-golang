...
// (connection_pool_*). It is capable of running an observer that
...
// connection pools.
func NewConnectionPoolMetrics(appName string) *ConnectionPoolMetrics {
	m := ConnectionPoolMetrics{
		...
		totalConns: prometheus.NewGaugeVec(
			prometheus.GaugeOpts{
				Namespace: appName,
				Subsystem: "postgres",
				Name:      "connection_pool_total_conns",
		...
		idleConns: prometheus.NewGaugeVec(
			prometheus.GaugeOpts{
				Namespace: appName,
				Subsystem: "postgres",
				Name:      "connection_pool_idle_conns",
		...
		staleConns: prometheus.NewGaugeVec(
			prometheus.GaugeOpts{
				Namespace: appName,
				Subsystem: "postgres",
				Name:      "connection_pool_stale_conns",
